...
function Navbar() {
  return (
    <div className=" min-h-screen bg-bgcard bg-center bg-cover px-28 py-8 relative">
      <nav className="flex justify-center items-center">
        <ul className="flex text-center justify-center items-center">
          <li className="font-semibold list-none inline-block px-5 lg:mx-10 md:mx-4 sm:mx:8">
